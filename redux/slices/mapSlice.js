...
const initialState = {
  ...
  center: zeroStart,
  countries: {
    ca: {flag: '/assets/flags/ca.svg', name: 'Canada', code: 'CA', coords: {lat: 61.6754281, lng: -100.4194553}, zoom: 4}, //desktopZoom: 4, mobileZoom: 2},
    us: {flag: '/assets/flags/us.svg', name: 'United States', code: 'US', coords: {lat: 38.3260721, lng: -96.8142871}, zoom: 5}, //desktopZoom: 5, mobileZoom: 3},
    gb: {flag: '/assets/flags/gb.svg', name: 'Great Britain', code: 'GB', coords: {lat: 54.166956, lng: -1.743242}, zoom: 6}, //desktopZoom: 6, mobileZoom: 5},
    de: {flag: '/assets/flags/de.svg', name: 'Deutschland', code: 'DE', coords: {lat: 51.101557, lng: 10.411623}, zoom: 6}, //desktopZoom: 6, mobileZoom: 5},
    au: {flag: '/assets/flags/au.svg', name: 'Australia', code: 'AU', coords: {lat: -25.545303, lng: 135.251798}, zoom: 5}, //desktopZoom: 5, mobileZoom: 3},
  },
